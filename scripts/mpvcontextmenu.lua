...
local function audTrackMenu()
    ...
    if not (#audTrackCount == 0) then
        for i = 1, (#audTrackCount), 1 do
            ...
            if (i == 1) then
                table.insert(audTrackMenuVal, {RADIO, "Disabled", "", "set aid 0", function() return noneCheck("aid") end, false})
...
mp.register_event("file-loaded", function()
    menuList = {
        ...
        playback_menu = {
            ...
            {COMMAND, "Clear Playlist", "Shift+L", "playlist-clear", "", false},
        },
        ...
        scale_menu = {
            {RADIO, "Bilinear", "", [[set scale "bilinear"]], function() return propNative("scale")=="bilinear" end, false},
            {RADIO, "Spline36", "", [[set scale "spline36"]], function() return propNative("scale")=="spline36" end, false},
            {RADIO, "Lanczos", "", [[set scale "lanczos"]], function() return propNative("scale")=="lanczos" end, false},
            {RADIO, "EWA Lanczos", "", [[set scale "ewa_lanczos"]], function() return propNative("scale")=="ewa_lanczos" end, false},
            {RADIO, "EWA Lanczos Sharp", "", [[set scale "ewa_lanczossharp"]], function() return propNative("scale")=="ewa_lanczossharp" end, false},
            {RADIO, "EWA Lanczos Soft", "", [[set scale "ewa_lanczossoft"]], function() return propNative("scale")=="ewa_lanczossoft" end, false},
            {RADIO, "Mitchell", "", [[set scale "mitchell"]], function() return propNative("scale")=="mitchell" end, false},
            {RADIO, "Oversample", "", [[set scale "oversample"]], function() return propNative("scale")=="oversample" end, false},
        },

        cscale_menu = {
            {RADIO, "Bilinear", "", [[set cscale "bilinear"]], function() return propNative("cscale")=="bilinear" end, false},
            {RADIO, "Spline36", "", [[set cscale "spline36"]], function() return propNative("cscale")=="spline36" end, false},
            {RADIO, "Lanczos", "", [[set cscale "lanczos"]], function() return propNative("cscale")=="lanczos" end, false},
            {RADIO, "EWA Lanczos", "", [[set cscale "ewa_lanczos"]], function() return propNative("cscale")=="ewa_lanczos" end, false},
            {RADIO, "EWA Lanczos Sharp", "", [[set cscale "ewa_lanczossharp"]], function() return propNative("cscale")=="ewa_lanczossharp" end, false},
            {RADIO, "EWA Lanczos Soft", "", [[set cscale "ewa_lanczossoft"]], function() return propNative("cscale")=="ewa_lanczossoft" end, false},
            {RADIO, "Mitchell", "", [[set cscale "mitchell"]], function() return propNative("cscale")=="mitchell" end, false},
            {RADIO, "Oversample", "", [[set cscale "oversample"]], function() return propNative("cscale")=="oversample" end, false},
        },

        dscale_menu = {
            {RADIO, "Bilinear", "", [[set dscale "bilinear"]], function() return propNative("dscale")=="bilinear" end, false},
            {RADIO, "Spline36", "", [[set dscale "spline36"]], function() return propNative("dscale")=="spline36" end, false},
            {RADIO, "Lanczos", "", [[set dscale "lanczos"]], function() return propNative("dscale")=="lanczos" end, false},
            {RADIO, "EWA Lanczos", "", [[set dscale "ewa_lanczos"]], function() return propNative("dscale")=="ewa_lanczos" end, false},
            {RADIO, "EWA Lanczos Sharp", "", [[set dscale "ewa_lanczossharp"]], function() return propNative("dscale")=="ewa_lanczossharp" end, false},
            {RADIO, "EWA Lanczos Soft", "", [[set dscale "ewa_lanczossoft"]], function() return propNative("dscale")=="ewa_lanczossoft" end, false},
            {RADIO, "Mitchell", "", [[set dscale "mitchell"]], function() return propNative("dscale")=="mitchell" end, false},
            {RADIO, "Oversample", "", [[set dscale "oversample"]], function() return propNative("dscale")=="oversample" end, false},
        },

        tscale_menu = {
            {RADIO, "Oversample", "", [[set tscale "oversample"]], function() return propNative("tscale")=="oversample" end, false},
            {RADIO, "Linear", "", [[set tscale "linear"]], function() return propNative("tscale")=="linear" end, false},
            {RADIO, "Catmull-Rom", "", [[set tscale "catmull_rom"]], function() return propNative("tscale")=="catmull_rom" end, false},
            {RADIO, "Mitchell", "", [[set tscale "mitchell"]], function() return propNative("tscale")=="mitchell" end, false},
            {RADIO, "Bicubic", "", [[set tscale "bicubic"]], function() return propNative("tscale")=="bicubic" end, false},
        },

        dither_menu = {
            {RADIO, "No", "", [[set dither-depth "oversample"]], function() return propNative("dither-depth")=="no" end, false},
            {RADIO, "Auto", "", [[set dither-depth "auto"]], function() return propNative("dither-depth")=="auto" end, false},
            {SEP},
            {RADIO, "8-bit", "", [[set dither-depth "8"]], function() return propNative("dither-depth")=="8" end, false},
        ...
        fbo_menu = {
            ...
            {SEP},
            {RADIO, "RGB8", "", [[set fbo-format "rgb8"]], function() return propNative("fbo-format")=="rgb8" end, false},
            {RADIO, "RGB10_A2", "", [[set fbo-format "rgb10_a2"]], function() return propNative("fbo-format")=="rgb10_a2" end, false},
            {RADIO, "RGBA16", "", [[set fbo-format "rgba16"]], function() return propNative("fbo-format")=="rgba16" end, false},
            {RADIO, "RGBA16F", "", [[set fbo-format "rgba16f"]], function() return propNative("fbo-format")=="rgba16f" end, false},
            {RADIO, "RGBA16HF", "", [[set fbo-format "rgba16hf"]], function() return propNative("fbo-format")=="rgba16hf" end, false},
            {RADIO, "RGBA32F", "", [[set fbo-format "rgba32f"]], function() return propNative("fbo-format")=="rgba32f" end, false},
        },
        ...
        primary_menu = {
            {RADIO, "Auto", "", [[set target-prim "auto"]], function() return propNative("target-prim")=="auto" end, false},
            {SEP},
            {RADIO, "ITU-R BT.470 M", "", [[set target-prim "bt.470m"]], function() return propNative("target-prim")=="bt.470m" end, false},
            {RADIO, "ITU-R BT.601 (525)", "", [[set target-prim "bt.601-525"]], function() return propNative("target-prim")=="bt.601-525" end, false},
            {RADIO, "ITU-R BT.601 (625)", "", [[set target-prim "bt.601-625"]], function() return propNative("target-prim")=="bt.601-625" end, false},
            {RADIO, "ITU-R BT.709", "", [[set target-prim "bt.709"]], function() return propNative("target-prim")=="bt.709" end, false},
            {RADIO, "ITU-R BT.2020", "", [[set target-prim "bt.2020"]], function() return propNative("target-prim")=="bt.2020" end, false},
            {RADIO, "Apple RGB", "", [[set target-prim "apple"]], function() return propNative("target-prim")=="apple" end, false},
            {RADIO, "Adobe RGB (1998)", "", [[set target-prim "adobe"]], function() return propNative("target-prim")=="adobe" end, false},
            {RADIO, "ProPhoto RGB", "", [[set target-prim "prophoto"]], function() return propNative("target-prim")=="prophoto" end, false},
            {RADIO, "CIE 1931 RGB", "", [[set target-prim "cie1931"]], function() return propNative("target-prim")=="cie1931" end, false},
            {RADIO, "DCI-P3", "", [[set target-prim "dci-p3"]], function() return propNative("target-prim")=="dci-p3" end, false},
            {RADIO, "Panasonic V-Gamut", "", [[set target-prim "v-gamut"]], function() return propNative("target-prim")=="v-gamut" end, false},
        ...
        trc_menu = {
            ...
            {RADIO, "sRGB", "", [[set target-trc "srgb"]], function() return propNative("target-trc")=="srgb" end, false},
            {RADIO, "Linear", "", [[set target-trc "linear"]], function() return propNative("target-trc")=="linear" end, false},
            {RADIO, "1.8 / Apple RGB", "", [[set target-trc "gamma1.8"]], function() return propNative("target-trc")=="gamma1.8" end, false},
            {RADIO, "2.0", "", [[set target-trc "gamma2.0"]], function() return propNative("target-trc")=="gamma2.0" end, false},
            {RADIO, "2.2", "", [[set target-trc "gamma2.2"]], function() return propNative("target-trc")=="gamma2.2" end, false},
            {RADIO, "2.4", "", [[set target-trc "gamma2.4"]], function() return propNative("target-trc")=="gamma2.4" end, false},
            {RADIO, "2.6", "", [[set target-trc "gamma2.6"]], function() return propNative("target-trc")=="gamma2.6" end, false},
            {RADIO, "2.8", "", [[set target-trc "gamma2.8"]], function() return propNative("target-trc")=="gamma2.8" end, false},
            {RADIO, "ProPhoto RGB", "", [[set target-trc "prophoto"]], function() return propNative("target-trc")=="prophoto" end, false},
            {RADIO, "ITU-R BT.2100 PQ", "", [[set target-trc "pq"]], function() return propNative("target-trc")=="pq" end, false},
            {RADIO, "ITU-R BT.2100 HLG", "", [[set target-trc "hlg"]], function() return propNative("target-trc")=="hlg" end, false},
            {RADIO, "Panasonic V-Log", "", [[set target-trc "v-log"]], function() return propNative("target-trc")=="v-log" end, false},
            {RADIO, "Sony S-Log1", "", [[set target-trc "s-log1"]], function() return propNative("target-trc")=="s-log1" end, false},
            {RADIO, "Sony S-Log2", "", [[set target-trc "s-log2"]], function() return propNative("target-trc")=="s-log2" end, false},
        },
        ...
        tonemap_menu = {
            {RADIO, "Clip", "", [[set tone-mapping "clip"]], function() return propNative("tone-mapping")=="clip" end, false},
            {RADIO, "Linear", "", [[set tone-mapping "linear"]], function() return propNative("tone-mapping")=="linear" end, false},
            {RADIO, "Gamma", "", [[set tone-mapping "gamma"]], function() return propNative("tone-mapping")=="gamma" end, false},
            {RADIO, "Mobius", "", [[set tone-mapping "mobius"]], function() return propNative("tone-mapping")=="mobius" end, false},
            {RADIO, "Reinhard", "", [[set tone-mapping "reinhard"]], function() return propNative("tone-mapping")=="reinhard" end, false},
            {RADIO, "Hable", "", [[set tone-mapping "hable"]], function() return propNative("tone-mapping")=="hable" end, false},
        },
